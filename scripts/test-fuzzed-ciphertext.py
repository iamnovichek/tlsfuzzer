...
def main():
    ...
    print("Basic test to verify if AES-128-GCM tags are being checked by the".upper())
    print("server. Expects TLS 1.2 or earlier and RSA key exchange (or (EC)DHE".upper())
    print("if -d option is used".upper())
    print("=" * CHARACTERS_LENGTH)
    time.sleep(3)
