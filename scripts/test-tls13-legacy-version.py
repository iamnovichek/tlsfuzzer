...
def main():
    ...
    print("Check that invalid legacy versions are rejected".upper())
    print("with protocol version alert by the TLS 1.3 server.".upper())
    print("=" * CHARACTERS_LENGTH)
    time.sleep(3)
    ...
    for prot_version in [(3, 0), (0, 0), (2, 0), (0, 2),
                         (1, 0), (1, 3), (1, 2), (0, 1)]:
        conversation = Connect(host, port)
        node = conversation
        ciphers = [CipherSuite.TLS_AES_128_GCM_SHA256,
