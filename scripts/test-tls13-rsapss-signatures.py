...
def help_msg():
    ...
    print(" -b             if present, test expect the server to have both, the")
...
def main():
    ...
    print("Check that server will send the Certificate Verify message".upper())
    print("for signatures with RSASSA-PSS encryption certificate.".upper())
    print("=" * CHARACTERS_LENGTH)
    time.sleep(3)
