...
def main():
    ...
    print("Test if server aborts connection upon receiving record layer with".upper())
    print("unexpected content type".upper())
    print("24 is hearbeat but it's not negotiated".upper())
    print("=" * CHARACTERS_LENGTH)
    time.sleep(3)
