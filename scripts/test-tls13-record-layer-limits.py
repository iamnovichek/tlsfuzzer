...
def main():
    ...
    print("Verify that too big Application Data messages, with".upper())
    print("different ciphers or fuzzed AEAD tag in TLS 1.3 communication ".upper())
    print("are rejected with record_overflow alert.".upper())
    print("=" * CHARACTERS_LENGTH)
    time.sleep(3)
