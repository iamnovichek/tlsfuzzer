...
def main():
    ...
    print("Check that server replies with HRR, aborts the connection".upper())
    print("with handshake_failure or chooses a known group from client list.".upper())
    print("Groups with IDs from FFDHE and ECDH range.".upper())
    print("=" * CHARACTERS_LENGTH)
    time.sleep(3)
